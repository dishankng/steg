function [  psnr,afterLSB,stegoImage,count,messageSize ] = SmartHaarEncode( cover,messageImage )
...
[stegoImage, count, messageSize, ~] = SmartLSBEncode(int16(cDint), messageImage);
